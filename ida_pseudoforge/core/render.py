...
def render_cleaned_pseudocode(capture: FunctionCapture, plan: CleanPlan) -> str:
    ...
    native_switch_dispatchers = _native_switch_dispatchers(text, plan)
    ...
    header = [
        ...
        f"    Kernel semantic rewrites: {_kernel_semantic_rewrite_count(plan)}",
    ...
    if plan.flow_rewrites:
        ...
        body_sections.append(
            ...
            "*/\n\n"
            + render_switch_outline(capture, plan, rendered_text=text).rstrip()
        )
    else:
