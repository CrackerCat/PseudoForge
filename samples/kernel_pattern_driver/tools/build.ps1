...
$solution = Join-Path $sampleRoot "PfKernelPattern.sln"
...
Write-Host "Driver: $(Join-Path $outDir 'PfKernelPattern.sys')"
Write-Host "Tool:   $(Join-Path $outDir 'PfKernelPatternTool.exe')"
